...
angular.module('pulse').factory('API', function ($http) {
    ...
    var transactionUrl = "http://192.168.25.62:8090/transaction-api/transaction-api/order";
    ...
    var UrlFactory = {
        ...
        transactionManager: function() {
            return transactionUrl + "/query";
        },
        transactionStatistics: function() {
            return transactionUrl + "/statistics";
        },
        statisticsIncome: function() {
            return transactionUrl + "/statistics/income"
        },
        statisticsTimes: function() {
            return transactionUrl + "/statistics/times"
        },
        statisticsOnce: function() {
            return transactionUrl + "/statistics/once"
        },
        statisticsCheckSrcTimes: function() {
            return transactionUrl + "/statistics/check_src"
        },
